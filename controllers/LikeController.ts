 ...
 *     </li>
 *     <li>GET /api/users/:uid/if/likes/:tid to check if a user likes a tuit</li>
 * </ul>
...
export default class LikeController implements LikeControllerI {
  ...
  public static getInstance = (app: Express): LikeController => {
    if (LikeController.likeController === null) {
      ...
      app.get(
        "/api/users/:uid/if/likes/:tid",
        LikeController.likeController.findIfUserLikesTuit
      );
  ...
  /**
   * Check if a certain user likes a tuit
   ...
   * database
   */
  findIfUserLikesTuit = (req: Request, res: Response) => {
    ...
    LikeController.likeDao
      .findUserLikesTuit(userId, req.params.tid)
